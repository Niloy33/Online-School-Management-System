...
<body>
    ...
    <table>
        ...
        <?php 
            $sql = "SELECT * FROM gurdian_notice";
...
if (isset($_POST['class']) && $_POST['class'] != '' && isset($_POST['notice']) && $_POST['notice'] != '') {
    ...
    $class = $_POST['class'];
    $notice = $_POST['notice'];
    $sql = "insert into gurdian_notice (class, notice) values ('$class', '$notice')";

    mysqli_query($con, $sql);

    header('location: notice_gurdian.php');
}
